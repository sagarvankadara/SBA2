...
public class ClerkController {
	...
	public ResponseEntity<ProcessingDto> processLoan(@PathVariable Long clerkId, @PathVariable Long loanAppId,
			@Valid @RequestBody ProcessingDto processingDto, BindingResult bindingResult) throws InvalidDataException {
		if (bindingResult.hasErrors()) {
			throw new InvalidDataException("Invalid details provided");
		}
		return new ResponseEntity<ProcessingDto>(clerkService.processLoan(clerkId, loanAppId, processingDto),
				HttpStatus.OK);
	}
